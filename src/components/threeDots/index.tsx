      ...
      {isModalOpen && (
        <Modal className="p-8" hideModal={closeModal}>
          <div className="flex flex-col gap-6">
            ...
            <p className="text-medium-gray">{`Are you sure you want to delete the '${activeBoard?.board}' board? This action will remove all columns and tasks and cannot be reversed.`}</p>
